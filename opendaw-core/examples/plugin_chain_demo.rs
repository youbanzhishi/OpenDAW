...
use opendaw_core::{engine_to_ext, ext_to_engine, EngineAudioBuffer, ExtAudioBuffer, PluginChain};
...
impl opendaw_extension::VcPlugin for GainPlugin {
    ...
    fn set_param(&mut self, id: &str, value: f64) -> Result<(), opendaw_extension::PluginError> {
        if id == "gain" {
            ...
            Err(opendaw_extension::PluginError::ParamNotFound(
                id.to_string(),
            ))
        }
    }
