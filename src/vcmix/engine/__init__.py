...
This subpackage provides:
    ...
    - ArrangementStrategy: Section-level mixing parameter generation (Phase 7)
    - SectionMixParams: Per-section effect parameters (Phase 7)
...
__all__ = [
    "Renderer", "Analyzer", "AutoFix", "AutoMixer",
    "BusManager", "SendReturnBus",
    "ArrangementStrategy", "SectionMixParams",
]
